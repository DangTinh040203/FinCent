    ...
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        `
          ...
          contain-content
          data-autoscrolling:scrollbar-none
        `,
        className
      )}
      {...props}
...
function MessageScrollerButton({
  ...
  return (
    <MessageScrollerPrimitive.Button
      ...
      className={cn(
        `
          border-border bg-background text-foreground absolute inset-s-1/2
          -translate-x-1/2 transition-[translate,scale,opacity] duration-200
