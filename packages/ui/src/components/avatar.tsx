...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        `
          bg-primary text-primary-foreground ring-background absolute right-0
          bottom-0 z-10 inline-flex items-center justify-center rounded-full
          ring-2 select-none
        `,
        `
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        `
          bg-muted text-muted-foreground ring-background relative flex size-8
          shrink-0 items-center justify-center rounded-full text-sm ring-2
