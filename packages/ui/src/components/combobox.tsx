        ...
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            `
              ...
              ring-foreground/10 relative max-h-96 w-(--anchor-width)
    ...
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        `
          ...
          pointer-coarse:px-3 pointer-coarse:py-2 pointer-coarse:text-sm
        `,
        className
      )}
      {...props}
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        `
          border-input flex min-h-9 flex-wrap items-center gap-1.5 rounded-md
          border bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs
          transition-[color,box-shadow]
          focus-within:border-ring focus-within:ring-ring/50
          focus-within:ring-[3px]
          has-aria-invalid:border-destructive
          has-aria-invalid:ring-destructive/20 has-aria-invalid:ring-[3px]
    ...
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        `
          ...
          items-center justify-center gap-1 rounded-sm px-1.5 text-xs
